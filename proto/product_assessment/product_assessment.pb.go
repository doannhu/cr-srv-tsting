...
// ProductRateRequest represents the request to get product rate
type ProductRateRequest struct {
...
func (x *ProductRateRequest) String() string {
...
func (x *ProductRateRequest) GetProductName() string {
	if x != nil {
...
// ProductRateResponse represents the response from product service
type ProductRateResponse struct {
	state                     protoimpl.MessageState `protogen:"open.v1"`
	InitialStructureIndexRate int64                  `protobuf:"varint,1,opt,name=initial_structure_index_rate,json=initialStructureIndexRate,proto3" json:"initial_structure_index_rate,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *ProductRateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProductRateResponse) GetInitialStructureIndexRate() int64 {
	if x != nil {
		return x.InitialStructureIndexRate
	}
	return 0
}
